...
console.log("hii saurbah")
console.log(from, to);
let fromVal;
let toVal;
//console.log(fromVal, toVal);

function convertor(first, second) {
    console.log(first);
    console.log(second);
...
calculate.addEventListener("click", ()=> {
    fromVal = from.options[from.selectedIndex].value;
    toVal = to.options[to.selectedIndex].value;
    let result = convertor(fromVal,toVal);
    console.log(result);
